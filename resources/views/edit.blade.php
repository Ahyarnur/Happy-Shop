            ...
            <form enctype="multipart/form-data" action="{{ route('update', ['id'=>$edit])}}" method="post" class="flex gap-8">
                ...
                <div class="w-1/2">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="nama" class="block mt-1 w-full" type="text" name="nama" value="{{$edit->nama}}" required />
                        <x-input-error :messages="$errors->get('nama')" class="mt-2" />
                    </div>

                    <div class="mt-4">
                        <x-input-label for="harga" :value="__('Harga')" />
                        <x-text-input id="harga" class="block mt-1 w-full" type="text" name="harga" value="{{$edit->harga}}" x-mask:dynamic="$money($input, ',')" required />
